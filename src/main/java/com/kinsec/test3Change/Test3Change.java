...
public class Test3Change {

	public static void main(String[] args) {
		String url="http://192.168.201.210:8080/fileOnloadServerMVC/fileChangeTest";
		String resource="/opt/wyccs/2.12TestCs/apache-tomcat-8.5.47/webapps/fileOnloadServerMVC/WEB-INF/classes/fileInput/dcsFileChange";
		String fileFolder="/opt/wyccs/2.12TestCs/apache-tomcat-8.5.47/webapps/fileOnloadServerMVC/WEB-INF/classes/fileOutput/dcs/";
		int threadTimes=2;
		int signTimes=2;
		for (int i = 0; i < threadTimes; i++) {
			Runnable FileThreadTest=new FileChangeThreadTest(signTimes,resource,fileFolder,url);
